...
import sys
sys.path.append(".")
from project_del5 import (DataSet, QuantDataSet, QualDataSet, TextDataSet, TimeSeriesDataSet, TransactionDataSet, HeterogeneousDataSet)
...
def HeterogeneousDataSetTests():
    print("HeterogeneousDataSet class instantiation...")
    H = HeterogeneousDataSet(filenames) 
    print("===========================================================")
    print("Check HeterogeneousDataSet member attributes...")
    print("HeterogeneousDataSet.clean():")
    H.clean()
    print("===========================================================\n\n")
    print("HeterogeneousDataSet.explore():")
    H.explore()
    print("HeterogeneousDataSet.select():")
    H.select()
...
# and member methods)
#=====================================================================
from project_del5 import (ClassifierAlgorithm, SimpleKNNClassifier, DecisionTree, storeTree)
...
# and member methods)
#=====================================================================
from project_del5 import Experiment
...
if __name__=="__main__":
    # Here are two quantitative datasets, two qualitative datasets, one text dataset, one time series dataset, and one transaction dataset.
    filenames = ["Sales_Transactions_Dataset_Weekly.csv", "Concrete_Data_Yeh.csv", "loan_final.csv", "student-por.csv", "yelp.csv", "occupancy.csv", 'HealthyBasketData2.csv']    
    # test HeterogeneousDataSet
    HeterogeneousDataSetTests()
